...
// Función para crear un gradiente de fondo
const BackgroundGradient = (colorA, colorB) => {
    ...
    // Asegura que el fondo se renderice al final
    mesh.renderOrder = -99999
    return mesh
}
// Clase que configura la escena, cámara y renderizador
class Stage
{
    ...
    onResize()
    {
        ...
        // Ajusta la posición de la cámara en función del tamaño de la ventana
...
// Clase para manejar el cargador
class Loader
{
...
// Shaders para el efecto de rasgado
...
//Imagenes
 ...
 const images = [
     { 
        texture: textureLoader.load('https://images.pexels.com/photos/1925738/pexels-photo-1925738.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'),
...
const extraImages = [
    ...
    { file: 'https://images.pexels.com/photos/984949/pexels-photo-984949.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', colors: [[206,221,226], [219,213,222]] },
    { file: 'https://images.pexels.com/photos/1925738/pexels-photo-1925738.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', colors: [[199,199,210], [218,203,195]] },
]
